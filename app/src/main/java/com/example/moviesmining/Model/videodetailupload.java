package com.example.moviesmining.Model;

public class videodetailupload {
    public  String video_slide,video_type, video_thumb, video_url,video_name,
            video_description,video_category;

    public videodetailupload(String video_slide, String video_type, String video_thumb, String video_url, String video_name, String video_description, String video_category) {
